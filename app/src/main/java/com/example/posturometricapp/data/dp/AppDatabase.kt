...
import com.example.posturometricapp.data.dp.dao.PsychStateDao
...
@Database(
    entities = [SessionEntity::class, SensorDataEntity::class, PsychStateEntity::class],
    version = 2
)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun psychStateDao(): PsychStateDao
}